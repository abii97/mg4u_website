              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="w-full bg-surface-base border border-gray-200 rounded-md px-4 py-3 text-text-primary focus:outline-none focus:border-primary transition-colors duration-fast"
                ...
                <div>
                  ...
                  <textarea
                    id="message"
                    rows={4}
                    className="w-full bg-surface-base border border-gray-200 rounded-md px-4 py-3 text-text-primary focus:outline-none focus:border-primary transition-colors duration-fast resize-none"
                    placeholder="Tell us about your goals..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-primary text-text-inverse py-3 rounded-md font-semibold hover:bg-primary-hover transition-colors duration-fast"
                >
                  Send Message
                </button>
              </form>
          ...
          >
            <div className="bg-surface-alt border border-gray-100 rounded-md p-8 shadow-1">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-md font-semibold transition-colors duration-fast"
              >
            ...
            <div className="bg-surface-alt border border-gray-100 rounded-md p-8 shadow-1">
              ...
              <a href="mailto:hello@mediaguide4u.com" className="text-primary hover:text-primary-hover transition-colors duration-fast">
