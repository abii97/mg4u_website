...
const pillars = [
  { num: '01', icon: <IconShield />, title: 'Reputation, Crisis & Sustainability Communication', accent: 'border-l-primary/40', items: [
    { heading: 'Crisis desks & reputation management', desc: 'Real-time listening, rapid issue response and narrative repair across LinkedIn, X, Instagram, review sites and search—built for brands, institutions and public figures that can&rsquo;t afford missteps.' },
    ...
    { heading: 'Search-result & knowledge authority', desc: 'Strategic content, profiles and knowledge-panel-friendly assets that improve what appears when someone searches your brand or leadership, including discreet support around encyclopaedic and high-authority web properties.' },
  ]},
  { num: '02', icon: <IconSpark />, title: 'Creator & Meme-Led Campaigns', accent: 'border-l-purple-400/40', items: [
    ...
    { heading: 'Hashtag & moment amplification', desc: 'Planned trend-hijacks and hashtag pushes around key moments—product drops, announcements, events and campaigns—stacked on top of solid, always-on communication.' },
  ]},
  { num: '03', icon: <IconChat />, title: 'WhatsApp, SMS & Full-Stack Communication', accent: 'border-l-green-500/40', items: [
    { heading: 'WhatsApp & SMS marketing', desc: 'Flows for D2C, institutions and services—from cart recovery and admission journeys to appointment reminders and crisis updates—leveraging WhatsApp&rsquo;s 90%+ open rates in India and APAC.' },
  ...
  { num: '04', icon: <IconPin />, title: 'On-Ground, Events & Digital Foundations', accent: 'border-l-amber-500/40', items: [
    { heading: 'On-ground activations & events', desc: 'Bloggers&rsquo; meets, creator summits, campus activations and hospital/community events that tie seamlessly into your digital, PR and CSR narratives.' },
  ...
  return (
    <div className="min-h-screen py-section-y px-6">
      <div className="max-w-6xl mx-auto">
        <BlurFade delay={0.1}>
          <h1 className="text-4xl font-bold text-center mb-4 text-text-primary">Our Services</h1>
        </BlurFade>
        <BlurFade delay={0.2}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {pillars.map(({ num, icon, title, items, accent }, i) => (
            <BlurFade key={num} delay={0.15 + i * 0.1}>
              <div className={`bg-surface-alt border border-gray-100 border-l-2 rounded-md p-6 lg:p-8 shadow-1 hover:shadow-2 transition-shadow duration-base ${accent}`}>
