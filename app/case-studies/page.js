  ...
  return (
    <div className="min-h-screen py-section-y px-6">
      <div className="max-w-6xl mx-auto">
        <BlurFade delay={0.1}>
          <h1 className="text-4xl font-bold text-center mb-4 text-text-primary">Case Studies</h1>
        </BlurFade>
        <BlurFade delay={0.2}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {caseStudies.map(({ company, title, category, challenge, solution, result, stats }, i) => (
            <BlurFade key={company} delay={0.1 + i * 0.05}>
              <div className="bg-surface-alt border border-gray-100 rounded-md overflow-hidden flex flex-col shadow-1 hover:shadow-2 transition-shadow duration-base">
